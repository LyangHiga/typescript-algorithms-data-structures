...
const llNode_1 = __importDefault(require("./llNode"));
class LinkedList {
    constructor() {
        // add an element at the last position
        this.push = (key) => {
            const node = new llNode_1.default(key, this);
            if (!this.head) {
                this.head = node;
                this.tail = node;
            }
        ...
        this.unshift = (key) => {
            let node = new llNode_1.default(key, this);
            if (!this.head) {
                this.head = node;
                this.tail = node;
                this.length = 1;
        ...
        this.insert = (k, key) => {
            ...
            let newNode = new llNode_1.default(key, this);
